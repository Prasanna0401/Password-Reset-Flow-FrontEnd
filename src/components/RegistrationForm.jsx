...
const RegistrationForm = () => {
    ...
    const handleRegistration = (e) => {
        ...
        axios
            .post("https://password-reset-flow-be-apli.onrender.com/api/v1/auth/register", { "name": name, "email": email, "password": password })
            .then((response) => {
                    ...
                    <div className="bg-white p-6 rounded-lg w-full max-w-md flex flex-col justify-between">
                        <div>
                            ...
                            <ul className='list-decimal space-y-2'>
                                <li>This is an app for Password Reset Flow</li>
