...
const SignIn = () => {
    ...
    useEffect(() => {
        axios
            .get('https://password-reset-flow-be-apli.onrender.com/api/v1/auth/userInfo', { withCredentials: true })
            .then(() => {
    ...
    const handleLogin = (e) => {
        ...
        axios
            .post(
                'https://password-reset-flow-be-apli.onrender.com/api/v1/auth/login',
                { email, password },
                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                                ...
                                <button
                                    type="submit"
                                    className="text-white text-xl mx-36 bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                >
                                    Sign In
                                </button>
