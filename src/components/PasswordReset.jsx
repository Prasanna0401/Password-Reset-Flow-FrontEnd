...
const PasswordReset = () => {
    ...
    const handleGenerateResetLink = async () => {
        ...
        try {
            const response = await axios.post("https://password-reset-flow-be-apli.onrender.com/api/v1/auth/resetPassword", { email });
    ...
    const handleResetPassword = async () => {
        ...
        try {
            const response = await axios.post("https://password-reset-flow-be-apli.onrender.com/api/v1/auth/setNewPassword", { token, newPassword });
            alert(response.data.message);
