...
const UserDetails = () => {
    ...
    useEffect(() => {
        axios
            .get('https://password-reset-flow-be-apli.onrender.com/api/v1/auth/userInfo', {
    ...
    const handleSignOut = () => {
        axios
            .get('https://password-reset-flow-be-apli.onrender.com/api/v1/auth/signout', { withCredentials: true })
            .then((response) => {
